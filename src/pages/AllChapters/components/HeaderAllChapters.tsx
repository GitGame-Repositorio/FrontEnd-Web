    ...
    <HeaderGame namePage="Capítulos" notRedirect>
      <div className="order-3 flex-wrap w-full 2md:w-fit">
        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-3">
          <div className="justify-self-start w-full md:w-2/5 2md:w-40 lg:w-56 2xl:w-60 bg-primary-100 py-2.5 px-3 space-y-3 sm:space-y-0 rounded-xl">
            ...
            <div className="h-2.5 w-2/3 md:w-full bg-primary-400 rounded-lg">
              <div
                ...
                className={`h-full max-w-full rounded-lg bg-primary-800`}
              />
            </div>
          </div>

          <div className="bg-primary-100 border-solid h-full w-full md:w-3/5 2md:w-max border-primary-600 rounded-xl p-4 justify-self-center content-center">
